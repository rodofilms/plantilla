<?php
    /* - 
        Comprueba si el ID del usuario es igual al que inicio sesion, si no comprobara si 
         el usuario actual tiene privilegios para realzar la operacion 
    - */  
...
<div class="container-fluid">
    ...
    ?>
        <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
            ...
            <fieldset>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!----- Ocultar el cambio de estado a usuarios que no cuenten con
                        el privilegio autorizado ------>
            ...
            <!-- Comprobar si la cuenta a modificar es propia o impropia ---->
