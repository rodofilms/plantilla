//seleccionar todos los formularios que tengan la clase FormularioAjax
const formularios_ajax = document.querySelectorAll(".FormularioAjax");

//Funcion que enviara todos los datos al controlador/modelo
function enviar_formularios_ajax(e){
    ...
    //JSON de configuracion para envio de datos
    let config = {
        method: method,
        headers: encabezados,
        mode: 'cors',
...
//Funcion para detectar el submit del formulario que enviara los datos
